...
const dom = (() => {
  ...
  function showTaskModal(modal, projectIndex, taskIndex = false) {
    ...
    if (modal === 'addTask') {
      ...
      option.setAttribute('value', '');
      option.selected = true;
      option.innerText = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].title;
  ...
  function renderHeader(projectIndex) {
    ...
    if (typeof projectIndex === 'number') {
      ...
      document.title = `${_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].title} - TODO`;
    } else {
  ...
  function renderTasks(projectIndex) {
    let indexStart;
    let indexEnd;
    const currDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd');
    ...
    if (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList.length >= 1) {
      ...
      for (let j = indexStart; j < indexEnd; j += 1) {
        for (let i = 0; i < _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks.length; i += 1) {
          if (projectIndex === 'today' && _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule !== currDate) {
            continue;
          } else if (projectIndex === 'week' && !((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currDate)) >= 0 && (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currDate)) <= 7)) {
            continue;
          ...
          taskProject.classList.add('todo-item-pill', `${_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].color}-background`, 'toggle-task', 'todo-item-project-name');
