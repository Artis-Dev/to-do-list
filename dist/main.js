  ...
  function showTaskModal(modal, projectIndex, taskIndex = false) {
    ...
    if (modal === 'addTask') {
      ...
      const currentTaskPriority =
        _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].priority;
      const currentTaskSchedule =
        _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].schedule;
  ...
  function renderProjects() {
    ...
    for (let i = 0; i < _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList.length; i += 1) {
      ...
      projectIcon.classList.add(
        ...
        'fa-fw',
        _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[i].color,
        'sidebar-project',
    ...
    if (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList.length >= 1) {
      ...
      for (let j = indexStart; j < indexEnd; j += 1) {
        for (let i = 0; i < _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks.length; i += 1) {
          if (
            projectIndex === 'today' &&
            _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule !== currDate
          ) {
            continue;
          } else if (
            projectIndex === 'week' &&
            !(
              (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
                (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule),
                (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currDate),
              ) >= 0 &&
              (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
                (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].schedule),
                (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currDate),
            ...
            _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].priority !== 'high'
          ) {
            continue;
          } else if (
            projectIndex === 'completed' &&
            _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].tasks[i].done !== true
          ) {
            continue;
          }
          ...
          taskProject.classList.add(
            'todo-item-pill',
            `${_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[j].color}-background`,
            'toggle-task',
...
const validation = (() => {
  ...
  function addTask(event, projectIndex) {
    ...
    if (taskTitle !== '' && !Number.isNaN(taskProject)) {
      _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].createTask(
        taskProject,
        taskTitle,
        taskPriority,
        taskSchedule,
